(async function () {
  ...
  for (const opt of opciones) {
    ...
    data.totales.Salmos = data.lecturas.Salmos.length;
    ...
    data.totales.Sapienciales = data.lecturas.Sapienciales.length;

    // ===============================
    // TABLA PRINCIPAL
    // ===============================
    const tabla = [...doc.querySelectorAll("table")]
      .find(t => t.querySelector("th")?.textContent.includes("Historicos"));
  ...
  console.log("📦 Datos disponibles en window.zGuerrasData");
